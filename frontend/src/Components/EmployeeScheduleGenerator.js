        ...
        <div className="employeeScheduleGeneratorContainer">
            <h1 className="employeeScheduleGeneratorHeader">Schedule Generator: </h1>
                ...
                <form className="form">
                    ...
                    <input placeholder="employee_per_shift" className="form-control" type="text"
                           value={employee_per_shift} onChange={(e) => setEmployee_per_shift(e.target.value)}/>
                    <input placeholder="shifts" className="form-control" type="text" value={shifts}
                           onChange={(e) => setShifts(e.target.value)}/>
                </form>
                <button className="btn btn-primary col-sm-6 btnEmployeeScheduleGenerator" onClick={postData}> Generate</button>
